...
Subscript[\[CapitalOmega]\[CapitalOmega], 1][t_, t0_] = 
    ((-I/8)*(4*Delta*sz*(t - t0)*ww + H1*(2*sx*(t - t0)*ww*Cos[phi] + 
         sy*(Cos[phi + 2*t*ww] - Cos[phi + 2*t0*ww] + 2*(t - t0)*ww*
            Sin[phi]) + sx*(Sin[phi + 2*t*ww] - Sin[phi + 2*t0*ww]))))/ww
 
Subscript[\[CapitalOmega]\[CapitalOmega], 2][t_, t0_] = 
    ((I/64)*H1*(2*H1*sz*(-t + t0)*ww + 2*H1*sz*(t - t0)*ww*
        Cos[2*(phi + t*ww)] + 4*Delta*(sy + sx*(-t + t0)*ww)*
        Cos[phi + 2*t*ww] + 2*H1*sz*t*ww*Cos[2*(phi + t0*ww)] - 
       2*H1*sz*t0*ww*Cos[2*(phi + t0*ww)] - 4*Delta*sy*Cos[phi + 2*t0*ww] - 
       4*Delta*sx*t*ww*Cos[phi + 2*t0*ww] + 4*Delta*sx*t0*ww*
        Cos[phi + 2*t0*ww] + H1*sz*Sin[2*(t - t0)*ww] - 
       2*H1*sz*Sin[2*(phi + t*ww)] + 4*Delta*sx*Sin[phi + 2*t*ww] + 
       4*Delta*sy*t*ww*Sin[phi + 2*t*ww] - 4*Delta*sy*t0*ww*
        Sin[phi + 2*t*ww] + 2*H1*sz*Sin[2*(phi + t0*ww)] - 
       4*Delta*(sx + sy*(-t + t0)*ww)*Sin[phi + 2*t0*ww]))/ww^2
...
Hbarconst[tb_, ta_] = (2*sz*(ta - tb)*ww*(H1^2 + 16*Delta*ww) + 
      16*H1*sx*(ta - tb)*ww^2*Cos[phi] + 2*H1^2*sz*(-ta + tb)*ww*
       Cos[2*(phi + ta*ww)] + 
      H1*(-4*(-2*sy*ww + Delta*(sy + sx*(-ta + tb)*ww))*Cos[phi + 2*ta*ww] + 
        2*H1*sz*(-ta + tb)*ww*Cos[2*(phi + tb*ww)] + 
        H1*sz*(Sin[2*(-ta + tb)*ww] + 2*Sin[2*(phi + ta*ww)] - 
          2*Sin[2*(phi + tb*ww)]) + 
        4*((-2*sy*ww + Delta*(sy + sx*(ta - tb)*ww))*Cos[phi + 2*tb*ww] + 
          4*sy*(ta - tb)*ww^2*Sin[phi] + 
          (2*sx*ww - Delta*(sx + sy*(ta - tb)*ww))*Sin[phi + 2*ta*ww] + 
          (-2*sx*ww + Delta*(sx + sy*(-ta + tb)*ww))*Sin[phi + 2*tb*ww])))/
     (64*(ta - tb)*ww^2)
...
Subscript[\[CapitalOmega]\[CapitalOmega], 3][t_, t0_] = 
    ((I/3072)*H1*(64*Delta*H1*sz*(t - t0)*ww + 16*H1^2*sx*(t - t0)*ww*
        Cos[phi] + 32*Delta*H1*sz*(t - t0)*ww*Cos[2*(t - t0)*ww] - 
       48*Delta*H1*sz*t*ww*Cos[2*(phi + t*ww)] + 48*Delta*H1*sz*t0*ww*
        Cos[2*(phi + t*ww)] - 96*Delta^2*sy*Cos[phi + 2*t*ww] - 
       3*H1^2*sy*Cos[phi + 2*t*ww] + 96*Delta^2*sx*t*ww*Cos[phi + 2*t*ww] - 
       96*Delta^2*sx*t0*ww*Cos[phi + 2*t*ww] + 32*Delta^2*sy*t^2*ww^2*
        Cos[phi + 2*t*ww] + 4*H1^2*sy*t^2*ww^2*Cos[phi + 2*t*ww] - 
       64*Delta^2*sy*t*t0*ww^2*Cos[phi + 2*t*ww] - 8*H1^2*sy*t*t0*ww^2*
        Cos[phi + 2*t*ww] + 32*Delta^2*sy*t0^2*ww^2*Cos[phi + 2*t*ww] + 
       4*H1^2*sy*t0^2*ww^2*Cos[phi + 2*t*ww] - 
       12*H1^2*sy*Cos[3*phi + 2*t*ww] - 12*H1^2*sx*t*ww*Cos[3*phi + 2*t*ww] + 
       12*H1^2*sx*t0*ww*Cos[3*phi + 2*t*ww] + 4*H1^2*sy*t^2*ww^2*
        Cos[3*phi + 2*t*ww] - 8*H1^2*sy*t*t0*ww^2*Cos[3*phi + 2*t*ww] + 
       4*H1^2*sy*t0^2*ww^2*Cos[3*phi + 2*t*ww] - 
       3*H1^2*sy*Cos[3*phi + 4*t*ww] + 2*H1^2*sx*t*ww*Cos[3*phi + 4*t*ww] - 
       2*H1^2*sx*t0*ww*Cos[3*phi + 4*t*ww] + 
       6*H1^2*sy*Cos[phi + 2*t*ww - 2*t0*ww] + 4*H1^2*sx*t*ww*
        Cos[phi + 2*t*ww - 2*t0*ww] - 4*H1^2*sx*t0*ww*
        Cos[phi + 2*t*ww - 2*t0*ww] + H1^2*sy*Cos[phi + 4*t*ww - 2*t0*ww] - 
       48*Delta*H1*sz*t*ww*Cos[2*(phi + t0*ww)] + 48*Delta*H1*sz*t0*ww*
        Cos[2*(phi + t0*ww)] + 96*Delta^2*sy*Cos[phi + 2*t0*ww] + 
       3*H1^2*sy*Cos[phi + 2*t0*ww] + 96*Delta^2*sx*t*ww*Cos[phi + 2*t0*ww] - 
       96*Delta^2*sx*t0*ww*Cos[phi + 2*t0*ww] - 32*Delta^2*sy*t^2*ww^2*
        Cos[phi + 2*t0*ww] - 4*H1^2*sy*t^2*ww^2*Cos[phi + 2*t0*ww] + 
       64*Delta^2*sy*t*t0*ww^2*Cos[phi + 2*t0*ww] + 8*H1^2*sy*t*t0*ww^2*
        Cos[phi + 2*t0*ww] - 32*Delta^2*sy*t0^2*ww^2*Cos[phi + 2*t0*ww] - 
       4*H1^2*sy*t0^2*ww^2*Cos[phi + 2*t0*ww] + 
       12*H1^2*sy*Cos[3*phi + 2*t0*ww] - 12*H1^2*sx*t*ww*
        Cos[3*phi + 2*t0*ww] + 12*H1^2*sx*t0*ww*Cos[3*phi + 2*t0*ww] - 
       4*H1^2*sy*t^2*ww^2*Cos[3*phi + 2*t0*ww] + 8*H1^2*sy*t*t0*ww^2*
        Cos[3*phi + 2*t0*ww] - 4*H1^2*sy*t0^2*ww^2*Cos[3*phi + 2*t0*ww] - 
       6*H1^2*sy*Cos[phi - 2*t*ww + 2*t0*ww] + 4*H1^2*sx*t*ww*
        Cos[phi - 2*t*ww + 2*t0*ww] - 4*H1^2*sx*t0*ww*
        Cos[phi - 2*t*ww + 2*t0*ww] + 3*H1^2*sy*Cos[3*phi + 4*t0*ww] + 
       2*H1^2*sx*t*ww*Cos[3*phi + 4*t0*ww] - 2*H1^2*sx*t0*ww*
        Cos[3*phi + 4*t0*ww] - H1^2*sy*Cos[phi - 2*t*ww + 4*t0*ww] + 
       8*H1^2*sx*t*ww*Cos[3*phi + 2*(t + t0)*ww] - 8*H1^2*sx*t0*ww*
        Cos[3*phi + 2*(t + t0)*ww] + 16*H1^2*sy*t*ww*Sin[phi] - 
       16*H1^2*sy*t0*ww*Sin[phi] - 48*Delta*H1*sz*Sin[2*(t - t0)*ww] + 
       48*Delta*H1*sz*Sin[2*(phi + t*ww)] - 16*Delta*H1*sz*t^2*ww^2*
        Sin[2*(phi + t*ww)] + 32*Delta*H1*sz*t*t0*ww^2*Sin[2*(phi + t*ww)] - 
       16*Delta*H1*sz*t0^2*ww^2*Sin[2*(phi + t*ww)] - 
       96*Delta^2*sx*Sin[phi + 2*t*ww] - 3*H1^2*sx*Sin[phi + 2*t*ww] - 
       96*Delta^2*sy*t*ww*Sin[phi + 2*t*ww] + 96*Delta^2*sy*t0*ww*
        Sin[phi + 2*t*ww] + 32*Delta^2*sx*t^2*ww^2*Sin[phi + 2*t*ww] + 
       4*H1^2*sx*t^2*ww^2*Sin[phi + 2*t*ww] - 64*Delta^2*sx*t*t0*ww^2*
        Sin[phi + 2*t*ww] - 8*H1^2*sx*t*t0*ww^2*Sin[phi + 2*t*ww] + 
       32*Delta^2*sx*t0^2*ww^2*Sin[phi + 2*t*ww] + 4*H1^2*sx*t0^2*ww^2*
        Sin[phi + 2*t*ww] + 12*H1^2*sx*Sin[3*phi + 2*t*ww] - 
       12*H1^2*sy*t*ww*Sin[3*phi + 2*t*ww] + 12*H1^2*sy*t0*ww*
        Sin[3*phi + 2*t*ww] - 4*H1^2*sx*t^2*ww^2*Sin[3*phi + 2*t*ww] + 
       8*H1^2*sx*t*t0*ww^2*Sin[3*phi + 2*t*ww] - 4*H1^2*sx*t0^2*ww^2*
        Sin[3*phi + 2*t*ww] - 3*H1^2*sx*Sin[3*phi + 4*t*ww] - 
       2*H1^2*sy*t*ww*Sin[3*phi + 4*t*ww] + 2*H1^2*sy*t0*ww*
        Sin[3*phi + 4*t*ww] - 6*H1^2*sx*Sin[phi + 2*t*ww - 2*t0*ww] + 
       4*H1^2*sy*t*ww*Sin[phi + 2*t*ww - 2*t0*ww] - 4*H1^2*sy*t0*ww*
        Sin[phi + 2*t*ww - 2*t0*ww] + H1^2*sx*Sin[phi + 4*t*ww - 2*t0*ww] - 
       48*Delta*H1*sz*Sin[2*(phi + t0*ww)] + 16*Delta*H1*sz*t^2*ww^2*
        Sin[2*(phi + t0*ww)] - 32*Delta*H1*sz*t*t0*ww^2*
        Sin[2*(phi + t0*ww)] + 16*Delta*H1*sz*t0^2*ww^2*
        Sin[2*(phi + t0*ww)] + 96*Delta^2*sx*Sin[phi + 2*t0*ww] + 
       3*H1^2*sx*Sin[phi + 2*t0*ww] - 96*Delta^2*sy*t*ww*Sin[phi + 2*t0*ww] + 
       96*Delta^2*sy*t0*ww*Sin[phi + 2*t0*ww] - 32*Delta^2*sx*t^2*ww^2*
        Sin[phi + 2*t0*ww] - 4*H1^2*sx*t^2*ww^2*Sin[phi + 2*t0*ww] + 
       64*Delta^2*sx*t*t0*ww^2*Sin[phi + 2*t0*ww] + 8*H1^2*sx*t*t0*ww^2*
        Sin[phi + 2*t0*ww] - 32*Delta^2*sx*t0^2*ww^2*Sin[phi + 2*t0*ww] - 
       4*H1^2*sx*t0^2*ww^2*Sin[phi + 2*t0*ww] - 
       12*H1^2*sx*Sin[3*phi + 2*t0*ww] - 12*H1^2*sy*t*ww*
        Sin[3*phi + 2*t0*ww] + 12*H1^2*sy*t0*ww*Sin[3*phi + 2*t0*ww] + 
       4*H1^2*sx*t^2*ww^2*Sin[3*phi + 2*t0*ww] - 8*H1^2*sx*t*t0*ww^2*
        Sin[3*phi + 2*t0*ww] + 4*H1^2*sx*t0^2*ww^2*Sin[3*phi + 2*t0*ww] + 
       6*H1^2*sx*Sin[phi - 2*t*ww + 2*t0*ww] + 4*H1^2*sy*t*ww*
        Sin[phi - 2*t*ww + 2*t0*ww] - 4*H1^2*sy*t0*ww*
        Sin[phi - 2*t*ww + 2*t0*ww] + 3*H1^2*sx*Sin[3*phi + 4*t0*ww] - 
       2*H1^2*sy*t*ww*Sin[3*phi + 4*t0*ww] + 2*H1^2*sy*t0*ww*
        Sin[3*phi + 4*t0*ww] - H1^2*sx*Sin[phi - 2*t*ww + 4*t0*ww] + 
       8*H1^2*sy*(-t + t0)*ww*Sin[3*phi + 2*(t + t0)*ww]))/ww^3
...
Subscript[\[CapitalOmega]\[CapitalOmega], 2][t_, t0_] = 
    ((I/64)*H1*(-2*H1*sz*t*ww + 2*H1*sz*t0*ww + 2*H1*sz*t*ww*
        Cos[2*(phi + t*ww)] + 4*Delta*(sy - sx*t*ww)*Cos[phi + 2*t*ww] + 
       2*H1*sz*t*ww*Cos[2*(phi + t0*ww)] - 4*H1*sz*t0*ww*
        Cos[2*(phi + t0*ww)] - 4*Delta*sy*Cos[phi + 2*t0*ww] - 
       ...
       8*Delta*sy*t0*ww*Sin[phi + 2*t0*ww] + 8*Delta*sx*t0*ww*
        Sin[(-t + t0)*ww]*Sin[phi + (t + t0)*ww] - 
       4*H1*sz*t0*ww*Sin[(-t + t0)*ww]*Sin[2*phi + (t + t0)*ww]))/ww^2
    ...
    ((-I/3072)*H1*(3*(32*Delta^2 + H1^2)*sy*Cos[phi + 2*t*ww] + 
       ...
       t0*ww*(72*Delta*H1*sz - 16*Delta*H1*sz*Cos[2*(phi + t*ww)] + 
         ...
         48*H1^2*sy*Cos[2*(phi + t0*ww)]*Cos[phi + (t + t0)*ww]*
          Sin[(-t + t0)*ww] + 6*H1^2*sx*Sin[phi]*Sin[2*(-t + t0)*ww] + 
         ...
         16*Delta*H1*sz*Cos[phi + (t + t0)*ww]*Sin[(-t + t0)*ww]*
          Sin[phi + 2*t*ww] + 4*H1^2*sy*Cos[phi + (t + t0)*ww]*Sin[phi]*
          Sin[(-t + t0)*ww]*Sin[phi + 2*t*ww] - 4*H1^2*sy*
          Sin[3*phi + 2*t*ww] + H1^2*sx*Sin[phi]*Sin[2*phi + 4*t*ww] - 
         3*H1^2*sy*Sin[3*phi + 4*t*ww] + 24*H1^2*sx*Sin[phi]*
          Sin[2*(phi + t0*ww)] - 96*Delta^2*sy*Sin[phi + 2*t0*ww] + 
         24*H1^2*sy*Sin[phi + 2*t0*ww] + 48*Delta*H1*sz*Sin[phi]*
          Sin[phi + 2*t0*ww] - 80*Delta*H1*sz*Cos[phi + (t + t0)*ww]*
          Sin[(-t + t0)*ww]*Sin[phi + 2*t0*ww] - 4*H1^2*sy*
          Cos[phi + (t + t0)*ww]*Sin[phi]*Sin[(-t + t0)*ww]*
          Sin[phi + 2*t0*ww] + 24*Delta*H1*sz*Sin[phi + 2*t0*ww]^2 - 
         6*H1^2*sy*Sin[phi - 2*t*ww + 2*t0*ww] - 2*H1^2*sx*Sin[phi]*
          Sin[2*phi + 4*t0*ww] - 12*H1^2*sy*Sin[3*phi + 4*t0*ww] - 
         24*H1^2*sx*Sin[(-t + t0)*ww]*Sin[phi + (t + t0)*ww] + 
         16*Delta*H1*sz*Cos[phi + 2*t*ww]*Sin[(-t + t0)*ww]*
          Sin[phi + (t + t0)*ww] + 48*H1^2*sx*Cos[2*(phi + t0*ww)]*
          Sin[(-t + t0)*ww]*Sin[phi + (t + t0)*ww] + 80*Delta*H1*sz*
          Cos[phi + 2*t0*ww]*Sin[(-t + t0)*ww]*Sin[phi + (t + t0)*ww] - 
         2*H1^2*sx*Sin[phi]*Sin[2*(phi + (t + t0)*ww)] - 
         H1*Cos[phi]*(Cos[phi + 2*t0*ww]*(48*Delta*sz - 
             4*H1*sx*Sin[(-t + t0)*ww]*Sin[phi + (t + t0)*ww]) + 
           4*Cos[phi + 2*t*ww]*(8*Delta*sz + H1*sx*Sin[(-t + t0)*ww]*
              Sin[phi + (t + t0)*ww]) + H1*(-30*sx - 
             3*sx*Cos[2*phi + 4*t0*ww] + 6*sy*Sin[2*(-t + t0)*ww] + 
      ...
      (H1*(-96*Delta^2*sy*Cos[phi + 2*ta*ww] - 3*H1^2*sy*Cos[phi + 2*ta*ww] - 
         ...
         2*tb*ww*(32*Delta*H1*sz + 8*H1^2*sx*Cos[phi] + 16*Delta*H1*sz*
           ...
           3*H1^2*sy*Cos[2*phi + 4*ta*ww]*Sin[phi] + 4*H1^2*sx*
            ...
            Cos[phi + (ta + tb)*ww]*Sin[(ta - tb)*ww] + 6*H1^2*sx*Sin[phi]*
            Sin[2*(ta - tb)*ww] + 24*H1^2*sx*Sin[phi]*Sin[2*(phi + ta*ww)] - 
           96*Delta^2*sy*Sin[phi + 2*ta*ww] + 24*H1^2*sy*Sin[phi + 2*ta*ww] + 
           48*Delta*H1*sz*Sin[phi]*Sin[phi + 2*ta*ww] - 80*Delta*H1*sz*
            Cos[phi + (ta + tb)*ww]*Sin[(ta - tb)*ww]*Sin[phi + 2*ta*ww] - 
           4*H1^2*sy*Cos[phi + (ta + tb)*ww]*Sin[phi]*Sin[(ta - tb)*ww]*
            Sin[phi + 2*ta*ww] + 24*Delta*H1*sz*Sin[phi + 2*ta*ww]^2 - 
           2*H1^2*sx*Sin[phi]*Sin[2*phi + 4*ta*ww] - 12*H1^2*sy*
            Sin[3*phi + 4*ta*ww] - 6*H1^2*sy*Sin[phi + 2*ta*ww - 2*tb*ww] + 
           12*H1^2*sx*Sin[phi]*Sin[2*(phi + tb*ww)] - 96*Delta^2*sy*
            Sin[phi + 2*tb*ww] - 4*H1^2*sy*Sin[phi + 2*tb*ww] - 
           4*H1^2*sy*Cos[phi]^2*Sin[phi + 2*tb*ww] + 32*Delta*H1*sz*Sin[phi]*
            Sin[phi + 2*tb*ww] + 2*H1^2*sx*Sin[2*phi]*Sin[phi + 2*tb*ww] - 
           16*Delta*H1*sz*Cos[phi + (ta + tb)*ww]*Sin[(ta - tb)*ww]*
            Sin[phi + 2*tb*ww] + 4*H1^2*sy*Cos[phi + (ta + tb)*ww]*Sin[phi]*
            Sin[(ta - tb)*ww]*Sin[phi + 2*tb*ww] - 4*H1^2*sy*
           ...
           3*H1^2*sy*Sin[3*phi + 4*tb*ww] - 24*H1^2*sx*Sin[(ta - tb)*ww]*
            ...
            Sin[(ta - tb)*ww]*Sin[phi + (ta + tb)*ww] + 16*Delta*H1*sz*
            Cos[phi + 2*tb*ww]*Sin[(ta - tb)*ww]*Sin[phi + (ta + tb)*ww] + 
           8*Cos[phi + 2*ta*ww]*(12*Delta^2*sx - 3*H1^2*sx + 
             10*Delta*H1*sz*Sin[(ta - tb)*ww]*Sin[phi + (ta + tb)*ww]) - 
           2*H1^2*sx*Sin[phi]*Sin[2*(phi + (ta + tb)*ww)] + 
           H1*Cos[phi]*(30*H1*sx + 3*H1*sx*Cos[2*phi + 4*ta*ww] - 
             32*Delta*sz*Cos[phi + 2*tb*ww] - 6*H1*sy*Sin[2*(ta - tb)*ww] - 
             24*H1*sy*Sin[2*(phi + ta*ww)] - 2*H1*sy*Sin[2*phi + 4*ta*ww] - 
             12*H1*sy*Sin[2*(phi + tb*ww)] + H1*sy*Sin[2*phi + 4*tb*ww] - 
             4*H1*sx*Cos[phi + 2*tb*ww]*Sin[(ta - tb)*ww]*Sin[phi + 
                (ta + tb)*ww] + Cos[phi + 2*ta*ww]*(-48*Delta*sz + 4*H1*sx*
                Sin[(ta - tb)*ww]*Sin[phi + (ta + tb)*ww]) - 
             2*H1*sy*Sin[2*(phi + (ta + tb)*ww)]) + 6*H1^2*sy*
